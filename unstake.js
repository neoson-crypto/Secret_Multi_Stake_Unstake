 ...
 * */
const TEST = false; // 默认为 true，需要修改為 false
var UNStake_Amount = "1000000"; // 默認為 1 顆 $SCRT
...
var _unStake = async (account, amount, _validatorAddress) => {
    ...
    const memo = 'unstake from ' + Validator_Address;
...
const main = async () => {
    ...
    if (Validator_Address == "") {
        console.log("ERROR: Validator_Address 為空，請手動設置對應的 Validator_Address");
        exit(-1);
    }
